...
const I18N = {
  en: {
    'lang.label': 'Language',
    'tab.settings': 'Settings', 'tab.model': 'Model', 'tab.emotion': 'Emotion', 'tab.tts': 'TTS', 'tab.prompt': 'Prompt', 'tab.enhance': 'Enhance', 'tab.memory': 'Memory',
    ...
    'voice.hint': 'Start the pet first, then click Start Listening. Recognized text will be sent to AI automatically.',
    'voice.mode': 'Recognition Mode',
    'voice.mode.webspeech': 'Web Speech (built-in)',
    'voice.mode.api': 'API STT (record + transcribe)',
    'voice.mode.local': 'Local Offline (Windows)',
    'voice.lang': 'Recognition Language',
    'voice.device': 'Microphone Device',
    'voice.whisper.model': 'Whisper Model',
    'voice.auto': 'Auto Continuous Listen & Send',
    'voice.repair': 'Auto Text Repair (local)',
    'voice.autoHint': 'When auto mode is on, recognition restarts automatically and sends each sentence to AI.',
    'voice.listen': 'Start Listening',
    'voice.listening': 'Listening...',
    'voice.listeningAuto': 'Auto Listening...',
    'voice.stop': 'Stop',
    'voice.send': 'Send to AI',
    'voice.transcript.ph': 'Recognized text appears here...',
    'voice.stt.baseUrl': 'STT Base URL',
    'voice.stt.apiKey': 'STT API Key',
    'voice.stt.model': 'STT Model',
    'voice.stt.save': 'Save STT Settings',
    'voice.stt.hint': 'Leave empty to reuse main API settings',
    'voice.stt.placeholder': 'Empty = reuse main API',
    'voice.unsupported': 'Voice recognition is not supported in this environment.',
    'voice.listeningHint': 'Listening... Speak now.',
    'voice.recordingHint': 'Recording... Click Stop when done.',
    'voice.localListeningHint': 'Local offline recognition is listening...',
    'voice.transcribing': 'Transcribing audio...',
    'voice.sending': 'Sending voice text to AI...',
    'voice.sent': 'Voice text sent to AI.',
    'voice.stopped': 'Voice recognition stopped.',
    'voice.err.api': 'Please configure API first.',
    'voice.err.pet': 'Please start the pet first.',
    'voice.err.busy': 'AI is busy. Please try again in a moment.',
    'voice.err.empty': 'No recognized text. Please try again.',
    'voice.err.permission': 'Microphone permission denied. Please allow microphone access.',
    'voice.err.network': 'Speech recognition network service is unavailable. Please check your network/proxy and try again.',
    'voice.err.networkSwitch': 'Web Speech network failed. Switched to API STT mode automatically, please speak again.',
    'voice.err.networkSwitchLocal': 'Web Speech network failed. Switched to local offline STT automatically, please speak again.',
    'voice.err.noSpeech': 'No speech detected. Please try again.',
    'voice.err.sttUnavailable': 'STT service is unavailable in this build.',
    'voice.err.recorderUnavailable': 'Audio recorder is unavailable in this environment.',
    'voice.err.sttApi': 'Please configure STT API key first.',
    'voice.err.sttModel': 'No available STT model on current provider.',
    'voice.err.localUnavailable': 'Local offline STT is unavailable in this build.',
    'voice.err.localLangMissing': 'Local language pack is not installed on Windows for this language.',
    'voice.err.localDevice': 'No available microphone device for local offline STT.',
    'voice.err.sttAuth': 'STT authentication failed (invalid API key).',
    'voice.err.sttEndpoint': 'STT endpoint not found. Please check STT Base URL.',
    'voice.err.sttLanguage': 'Recognition language is not supported by STT API. Try zh / en / ja.',
    'voice.err.sttModelSwitch': 'Current API has no STT model. Switched to Web Speech automatically, please speak again.',
    'voice.err.sttModelSwitchLocal': 'Current API has no STT model. Switched to local offline STT automatically, please speak again.',
    'voice.err.sttFailed': 'STT failed: ',
    'memory.settings.title': 'Memory Settings', 'memory.settings.hint': 'Configure how AI remembers your conversations',
    'memory.settings.enabled': 'Enable Long-term Memory', 'memory.settings.enabledHint': 'AI will remember past conversations and retrieve relevant context automatically',
    'memory.settings.maxMemories': 'Max Memories to Keep', 'memory.settings.maxHint': 'Older memories will be automatically removed when limit is reached',
    'memory.settings.shortTermLimit': 'Short-term Memory Size', 'memory.settings.shortTermHint': 'Number of recent messages always included in context',
    'memory.settings.longTermLimit': 'Long-term Retrieval Limit', 'memory.settings.longTermHint': 'Number of relevant past memories to retrieve (0 = disable retrieval)',
    'memory.settings.autoSave': 'Auto-save to Local File', 'memory.settings.autoSaveHint': 'Automatically save memories to local file (userData/memories.json)',
    'memory.settings.test': 'Test Memory',
    'memory.title': 'Memory System', 'memory.hint': 'AI remembers your conversations locally using keyword-based search.',
    'memory.stats': 'Statistics', 'memory.total': 'Total Memories', 'memory.embedded': 'Today / This Week',
    'memory.recent': 'Recent Memories', 'memory.empty': 'No memories yet. Start chatting with your pet!',
    'memory.refresh': 'Refresh', 'memory.export': 'Export', 'memory.import': 'Import', 'memory.clear': 'Clear All',
    ...
    'sys.visionGuidance': '[Visual Task] Use the screenshot(s) as primary evidence. Mention 1-2 concrete on-screen details, avoid guessing unreadable text, then reply naturally and briefly.',
    'sys.currentScreenshotLabel': '[Current screenshot]',
    'sys.historyScreenshotLabel': '[Reference screenshot, {0}s ago]',
    'sys.noScreenshotHint': '[Visual input unavailable] Keep the response grounded in current app context; do not fabricate unseen details.',
  ...
  zh: {
    ...
    'voice.title': '语音输入',
    'voice.hint': '先启动宠物，再点击“开始监听”。识别文本会自动发送给 AI。',
    'voice.mode': '识别模式',
    'voice.mode.webspeech': 'Web Speech（内置）',
    'voice.mode.api': 'API 转写（录音+识别）',
    'voice.mode.local': '本地离线（Windows）',
    'voice.lang': '识别语言',
    'voice.device': '麦克风设备',
    'voice.whisper.model': 'Whisper 模型',
    'voice.auto': '自动连续监听并发送',
    'voice.repair': '文本自动修复（本地）',
    'voice.autoHint': '开启后会自动反复监听，并将每句话自动发送给 AI。',
    'voice.listen': '开始监听',
    'voice.listening': '监听中...',
    'voice.listeningAuto': '自动监听中...',
    'voice.stop': '停止',
    'voice.send': '发送给 AI',
    'voice.transcript.ph': '识别到的文本会显示在这里...',
    'voice.stt.baseUrl': 'STT Base URL',
    'voice.stt.apiKey': 'STT API Key',
    'voice.stt.model': 'STT 模型',
    'voice.stt.save': '保存 STT 设置',
    'voice.stt.hint': '留空则复用上方主 API 设置',
    'voice.stt.placeholder': '留空=复用主API',
    'voice.unsupported': '当前环境不支持语音识别。',
    'voice.listeningHint': '正在监听，请开始说话。',
    'voice.recordingHint': '正在录音，讲完后点击“停止”。',
    'voice.localListeningHint': '本地离线识别正在监听...',
    'voice.transcribing': '正在转写音频...',
    'voice.sending': '正在把语音文本发送给 AI...',
    'voice.sent': '语音文本已发送给 AI。',
    'voice.stopped': '已停止语音识别。',
    'voice.err.api': '请先配置 API。',
    'voice.err.pet': '请先启动宠物。',
    'voice.err.busy': 'AI 正在忙，请稍后再试。',
    'voice.err.empty': '没有识别到文本，请重试。',
    'voice.err.permission': '麦克风权限被拒绝，请允许麦克风访问。',
    'voice.err.network': '语音识别网络服务不可用，请检查网络/代理后重试。',
    'voice.err.networkSwitch': 'Web Speech 网络失败，已自动切到 API 转写模式，请重新说一次。',
    'voice.err.networkSwitchLocal': 'Web Speech 网络失败，已自动切到本地离线识别，请重新说一次。',
    'voice.err.noSpeech': '未检测到语音，请重试。',
    'voice.err.sttUnavailable': '当前构建不可用 STT 服务。',
    'voice.err.recorderUnavailable': '当前环境不支持录音。',
    'voice.err.sttApi': '请先配置 STT API Key。',
    'voice.err.sttModel': '当前供应商没有可用的 STT 模型。',
    'voice.err.localUnavailable': '当前构建不可用本地离线语音识别。',
    'voice.err.localLangMissing': '当前语言缺少 Windows 本地语音识别语言包。',
    'voice.err.localDevice': '未检测到可用麦克风，无法进行本地离线识别。',
    'voice.err.sttAuth': 'STT 认证失败（API Key 无效）。',
    'voice.err.sttEndpoint': '找不到 STT 接口，请检查 STT Base URL。',
    'voice.err.sttLanguage': '识别语言不被当前 STT 接口支持，建议改用 zh / en / ja。',
    'voice.err.sttModelSwitch': '当前 API 没有可用 STT 模型，已自动切换到 Web Speech，请再说一次。',
    'voice.err.sttModelSwitchLocal': '当前 API 没有可用 STT 模型，已自动切换到本地离线识别，请再说一次。',
    'voice.err.sttFailed': 'STT 失败：',
    'memory.settings.title': '记忆设置', 'memory.settings.hint': '配置 AI 如何记住你的对话',
    'memory.settings.enabled': '启用长期记忆', 'memory.settings.enabledHint': 'AI 会记住过去的对话并自动检索相关上下文',
    'memory.settings.maxMemories': '最大记忆数量', 'memory.settings.maxHint': '达到限制时会自动删除旧记忆',
    'memory.settings.shortTermLimit': '短期记忆大小', 'memory.settings.shortTermHint': '始终包含在上下文中的最近消息数量',
    'memory.settings.longTermLimit': '长期检索限制', 'memory.settings.longTermHint': '检索的相关历史记忆数量（0 = 禁用检索）',
    'memory.settings.autoSave': '自动保存到本地文件', 'memory.settings.autoSaveHint': '自动将记忆保存到本地文件 (userData/memories.json)',
    'memory.settings.test': '测试记忆',
    'memory.title': '记忆系统', 'memory.hint': 'AI 使用基于关键词的搜索在本地记住你的对话',
    'memory.stats': '统计信息', 'memory.total': '总记忆数', 'memory.embedded': '今天 / 本周',
    'memory.recent': '最近记忆', 'memory.empty': '还没有记忆。开始与你的宠物聊天吧！',
    'memory.refresh': '刷新', 'memory.export': '导出', 'memory.import': '导入', 'memory.clear': '清空全部',
    ...
    'sys.visionGuidance': '【视觉任务】以截图内容为主要依据，先提到1-2个屏幕上的具体细节；看不清的文字不要猜，然后自然简短地回复。',
    'sys.currentScreenshotLabel': '【当前截图】',
    'sys.historyScreenshotLabel': '【参考截图（{0}秒前）】',
    'sys.noScreenshotHint': '【视觉输入不可用】请基于当前应用上下文回复，不要编造未看到的细节。',
  ...
  ja: {
    ...
    'voice.title': '音声入力',
    'voice.hint': '先にペットを起動してから「聞き取り開始」を押してください。認識テキストは自動で AI に送信されます。',
    'voice.mode': '認識モード',
    'voice.mode.webspeech': 'Web Speech（内蔵）',
    'voice.mode.api': 'API STT（録音+文字起こし）',
    'voice.mode.local': 'ローカルオフライン（Windows）',
    'voice.lang': '認識言語',
    'voice.device': 'マイクデバイス',
    'voice.whisper.model': 'Whisper モデル',
    'voice.auto': '自動で連続聞き取り・送信',
    'voice.repair': 'テキスト自動補正（ローカル）',
    'voice.autoHint': '有効化すると自動で聞き取りを繰り返し、各文を AI に自動送信します。',
    'voice.listen': '聞き取り開始',
    'voice.listening': '聞き取り中...',
    'voice.listeningAuto': '自動聞き取り中...',
    'voice.stop': '停止',
    'voice.send': 'AI に送信',
    'voice.transcript.ph': '認識されたテキストがここに表示されます...',
    'voice.stt.baseUrl': 'STT Base URL',
    'voice.stt.apiKey': 'STT API Key',
    'voice.stt.model': 'STT モデル',
    'voice.stt.save': 'STT 設定を保存',
    'voice.stt.hint': '空欄の場合はメイン API 設定を使用',
    'voice.stt.placeholder': '空欄=メインAPI使用',
    'voice.unsupported': 'この環境では音声認識を利用できません。',
    'voice.listeningHint': '聞き取り中です。話してください。',
    'voice.recordingHint': '録音中です。終わったら「停止」を押してください。',
    'voice.localListeningHint': 'ローカルオフライン認識で聞き取り中...',
    'voice.transcribing': '音声を文字起こし中...',
    'voice.sending': '音声テキストを AI に送信しています...',
    'voice.sent': '音声テキストを AI に送信しました。',
    'voice.stopped': '音声認識を停止しました。',
    'voice.err.api': '先に API を設定してください。',
    'voice.err.pet': '先にペットを起動してください。',
    'voice.err.busy': 'AI が処理中です。少し待って再試行してください。',
    'voice.err.empty': '認識テキストがありません。再試行してください。',
    'voice.err.permission': 'マイク権限が拒否されました。マイクアクセスを許可してください。',
    'voice.err.network': '音声認識のネットワークサービスに接続できません。ネットワーク/プロキシを確認して再試行してください。',
    'voice.err.networkSwitch': 'Web Speech のネットワーク失敗を検出したため、API STT モードへ自動切替しました。もう一度話してください。',
    'voice.err.networkSwitchLocal': 'Web Speech のネットワーク失敗を検出したため、ローカルオフライン認識へ自動切替しました。もう一度話してください。',
    'voice.err.noSpeech': '音声を検出できませんでした。再試行してください。',
    'voice.err.sttUnavailable': 'このビルドでは STT サービスを利用できません。',
    'voice.err.recorderUnavailable': 'この環境では録音機能を利用できません。',
    'voice.err.sttApi': '先に STT API キーを設定してください。',
    'voice.err.sttModel': '現在のプロバイダでは STT モデルが利用できません。',
    'voice.err.localUnavailable': 'このビルドではローカルオフライン音声認識を利用できません。',
    'voice.err.localLangMissing': 'この言語の Windows 音声認識言語パックが見つかりません。',
    'voice.err.localDevice': '利用可能なマイクが見つからず、ローカルオフライン認識を実行できません。',
    'voice.err.sttAuth': 'STT 認証に失敗しました（API キーが無効です）。',
    'voice.err.sttEndpoint': 'STT エンドポイントが見つかりません。STT Base URL を確認してください。',
    'voice.err.sttLanguage': '認識言語が STT API で未対応です。zh / en / ja を試してください。',
    'voice.err.sttModelSwitch': '現在の API で STT モデルが使えないため、Web Speech に自動切替しました。もう一度話してください。',
    'voice.err.sttModelSwitchLocal': '現在の API で STT モデルが使えないため、ローカルオフライン認識に自動切替しました。もう一度話してください。',
    'voice.err.sttFailed': 'STT 失敗: ',
    'memory.settings.title': 'メモリ設定', 'memory.settings.hint': 'AI が会話を記憶する方法を設定',
    'memory.settings.enabled': '長期記憶を有効化', 'memory.settings.enabledHint': 'AI は過去の会話を記憶し、関連するコンテキストを自動的に取得します',
    'memory.settings.maxMemories': '最大記憶数', 'memory.settings.maxHint': '制限に達すると古い記憶が自動的に削除されます',
    'memory.settings.shortTermLimit': '短期記憶サイズ', 'memory.settings.shortTermHint': 'コンテキストに常に含まれる最近のメッセージ数',
    'memory.settings.longTermLimit': '長期取得制限', 'memory.settings.longTermHint': '取得する関連する過去の記憶の数（0 = 取得を無効化）',
    'memory.settings.autoSave': 'ローカルファイルに自動保存', 'memory.settings.autoSaveHint': 'ローカルファイルに記憶を自動保存 (userData/memories.json)',
    'memory.settings.test': 'メモリテスト',
    'memory.title': 'メモリシステム', 'memory.hint': 'AI はキーワードベースの検索を使用してローカルで会話を記憶します',
    'memory.stats': '統計', 'memory.total': '総記憶数', 'memory.embedded': '今日 / 今週',
    'memory.recent': '最近の記憶', 'memory.empty': 'まだ記憶がありません。ペットとチャットを始めましょう！',
    'memory.refresh': '更新', 'memory.export': 'エクスポート', 'memory.import': 'インポート', 'memory.clear': 'すべてクリア',
    ...
    'sys.visionGuidance': '【視覚タスク】スクリーンショットを最優先の根拠として扱い、画面上の具体的な要素を1-2点述べてください。読めない文字は推測せず、その後に自然で短く返答してください。',
    'sys.currentScreenshotLabel': '【現在のスクリーンショット】',
    'sys.historyScreenshotLabel': '【参照スクリーンショット（{0}秒前）】',
    'sys.noScreenshotHint': '【視覚入力なし】現在のアプリ文脈に沿って返答し、見えていない詳細は作らないでください。',
