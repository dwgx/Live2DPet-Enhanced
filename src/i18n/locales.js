...
const I18N = {
  en: {
    ...
    'memory.settings.autoSave': 'Auto-save to Browser Storage', 'memory.settings.autoSaveHint': 'Automatically save memories to localStorage for persistence',
  ...
  zh: {
    ...
    'memory.settings.autoSave': '自动保存到浏览器存储', 'memory.settings.autoSaveHint': '自动将记忆保存到 localStorage 以持久化',
  ...
  ja: {
    ...
    'memory.settings.autoSave': 'ブラウザストレージに自動保存', 'memory.settings.autoSaveHint': 'localStorage に記憶を自動保存して永続化',
