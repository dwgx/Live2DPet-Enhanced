...
Electron ベースのデスクトップペット。Live2D キャラクターがデスクトップに常駐し、スクリーンショットとウィンドウ認識であなたの作業内容を理解、AI がコンパニオン対話を生成、関連知識を自動検索・蓄積してより深い会話を実現、VOICEVOX で音声合成を行います。[Claude Code](https://docs.anthropic.com/en/docs/claude-code) による AI 支援開発で構築。
...
- **スマート拡張** — 関連知識の自動検索、画面状況分析、アクティビティ記憶でより深い会話を実現
